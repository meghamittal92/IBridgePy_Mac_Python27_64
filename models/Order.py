...
class KeyedIbridgePyOrders:
    ...
    def __str__(self):
        ...
        ans = 'Print models::Order::KeyedIbridgePyOrders\n'
    ...
    def createFromPlaceOrder(self, ibpyOrderId):
        if ibpyOrderId not in self.keyedIbridgePyOrders:
            ...
            pass
            # self.log.error(__name__ + '::KeyedIbridgePyOrders::createFromPlaceOrder: EXIT, ibpyOrderId=%s exist' % (ibpyOrderId,))
            # exit()

    def updateFromOpenOrder(self, openOrderRecord):
        self.log.notset(__name__ + '::KeyedIbridgePyOrders::updateFromOpenOrder: openOrderRecord=%s' % (openOrderRecord,))
    ...
    def get_ibridgePyOrder(self, ibpyOrderId):
        ...
        if self.has_ibpyOrderId(ibpyOrderId):
            ...
            self.log.error(__name__ + '::get_ibridgePyOrder: EXIT, cannot get order. accountCode=%s ibpyOrderId=%s' % (self.accountCode, ibpyOrderId))
            exit()
