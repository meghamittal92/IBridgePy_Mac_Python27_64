...
fileToStoreResults = "BackTestOutputs/" + '_'.join(['_'.join(securities), MODE, 'V5_over30days', originalCandleTimeFrame.replace(" ", ""),str(ADX_EXIT_THRESHHOLD), str(ADX_ENTRY_THRESHHOLD) + '.txt'])
