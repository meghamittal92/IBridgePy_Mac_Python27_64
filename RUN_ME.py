...
#fileName = 'moving_average_crossover.py'
#fileName = 'DICrossOverMultiThreadedV5.py'
...
# !!!!!! IMPORTANT  !!!!!!!!!!!!!!!!!
#accountCode = 'DU229338'  # You need to change it to your own IB account number
accountCode = 'DU1073267'
# !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
